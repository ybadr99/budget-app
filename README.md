...
```sh
  cd my-folder
  git clone git@github.com:ybadr99/rails-budget-app.git
  bundle install
```
...
- Linkedin: [ybadr99](https://www.linkedin.com/in/yousef-mohamed-badr)
...
Feel free to check the [issues page](https://github.com/ybadr99/rails-budget-app/issues).
